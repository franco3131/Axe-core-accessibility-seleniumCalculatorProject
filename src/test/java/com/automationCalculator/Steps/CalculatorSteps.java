...
public class CalculatorSteps {
    ...
    public void iGoToTheCalculatorPage() {
        calculator.goToUrl(
    ...
    public void iClickOnTheDivisionButton() {
        calculator.clickDivide();
    }

    @Then("The calculator outputs {int}")
    public void theCalculatorOutputsInt(int expected) {
    ...
    public void theCalculatorOutputsDecimal(double expected) {
